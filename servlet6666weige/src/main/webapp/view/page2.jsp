...
<body>
	<div class="table-responsive">
		...
		for(int i=0;i<button;i++){
			%>
			<a href="page.do?page=<%=i+1 %>">第<%=i+1 %>页</a>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="form-horizontal" role="form" action="" method="post" onsubmit=" checkNickName()+checkName()+checkCamp()==3">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input name="sex"  class="sex" type="radio" />男 
							<input name="sex" class="sex" type="radio"/>女
						</div>
					</div>
					<div class="form-group">
